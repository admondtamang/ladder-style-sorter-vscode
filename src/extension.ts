...
export function activate(context: vscode.ExtensionContext) {
    let disposable = vscode.commands.registerCommand('importLadder.sortImports', () => {
        ...
        if (!selectedText || selectedText.trim() === '') {
            ...
            if (result) {
                ...
                vscode.window.showErrorMessage('No imports found. Please select import statements.');
                return;
            }
        }
        ...
        editor.edit(editBuilder => {
            ...
            if (success) {
                vscode.window.showInformationMessage('Imports sorted in ladder style! 🪜');
            }
        });
    });
...
function autoDetectImports(document: vscode.TextDocument): { text: string; range: vscode.Range } | null {
